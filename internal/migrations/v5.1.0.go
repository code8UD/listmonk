...
// V5_1_0 performs the DB migrations for geographic extensions.
func V5_1_0(db *sqlx.DB, fs stuffbin.FileSystem, ko *koanf.Koanf, lo *log.Logger) error {
	lo.Println("Adding geographic extensions to subscribers table...")
	...
	lo.Println("Geographic extensions migration completed successfully")
	return nil
}